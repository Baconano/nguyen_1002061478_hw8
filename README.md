## Overview
This project implements the **Expectation Maximization (EM)** algorithm for Part-of-Speech (POS) tagging using the Wall Street Journal (WSJ) dataset. The implementation includes data preprocessing, parameter initialization, the Forward-Backward algorithm (E-step), and parameter updates (M-step).
